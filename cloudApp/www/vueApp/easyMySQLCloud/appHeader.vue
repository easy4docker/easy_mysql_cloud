<template>
    <div class="head-card card m-1">
        <div class="card-body m-0 p-1 alert-info header-bg ">
            ...
            <div class="pull-right pl-1 text-warning">Developer : John Xu</div>
            <div class="container-fluid mt-1 head-menu-2 text-left text-light">
                ...
                <a href="JavaScript:void(0)" v-on:click="module('tokens')" v-if="root.module !== 'tokens'" class="m-3 ml-1">User Tokens</a>
                <b class="m-3" v-if="root.module === 'tokens'">User Tokens</b> |
